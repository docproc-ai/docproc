  ...
  if (
    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-6">
        <div className="bg-card border rounded-2xl p-8 shadow-lg shadow-black/5 max-w-md w-full">
          ...
          <div className="flex items-start gap-3 bg-destructive/10 text-destructive rounded-lg p-4 text-sm">
            ...
            <span>
              No authentication methods are currently enabled. Please contact
              your administrator.
            </span>
          </div>
        </div>
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-card border rounded-2xl p-8 shadow-lg shadow-black/5">
          ...
          {authConfig.socialProviders.length > 0 && (
            <div
              className={`space-y-3 ${!authConfig.emailPasswordEnabled ? '' : ''}`}
            >
              {/* Show error here if no email/password form */}
              {!authConfig.emailPasswordEnabled && error && (
                <div className="flex items-start gap-3 bg-destructive/10 text-destructive rounded-lg p-4 text-sm mb-4">
                  <AlertCircle className="size-[18px] flex-shrink-0 mt-0.5" />
                  <span>{error}</span>
                </div>
              )}
